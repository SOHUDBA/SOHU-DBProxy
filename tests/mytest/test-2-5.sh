...
####### 1.2 设置账号连接限制 #######
$mysql_cmd "SetConnLimit --username=test --port-type=rw --hostip=$MYSQL_PROXY_WORKER_IP --conn-limit=20;"
...
####### 3. 检车结果是否正确，设置脚本退出码 #####
r="ERROR 3009 (08004): too many logins for this user. proxy@$MYSQL_PROXY_WORKER_IP, 20/20
20" #正确的结果
