...
typedef enum {
	...
	/*
	 * 接下来以TK_SQL_开头的是关键字，从TK_SQL_ACCESSIBLE（等于28）到TK_SQL_ZEROFILL（等于260）
	 * 参考sql-tokenizer-keywords.c，sql_keywords定义了这些关键字编号
	 * 参考sql-tokenizer-tokens.c，token_names定义了所有符号的名字
     */
