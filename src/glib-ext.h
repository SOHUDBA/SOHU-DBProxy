...
// added by jinxuan hou, for ghashtable in key or value destroy
CHASSIS_API void g_hash_table_int_free(gpointer data);
CHASSIS_API void g_hash_table_pool_config_free(gpointer data);
CHASSIS_API void g_hash_table_pool_status_free(gpointer data);
...
// added for  charset equal and hash, sohu-inc.com
CHASSIS_API guint g_hash_table_charset_string_hash(gconstpointer _key);
CHASSIS_API gboolean g_hash_table_charset_string_equal(gconstpointer _a, gconstpointer _b);

CHASSIS_API void g_string_myreplace(GString *mystring, const gchar *src, const gchar* rep);

CHASSIS_API gboolean wildcard_string_match1(const gchar *pattern, const gchar *string);
CHASSIS_API gboolean wildcard_string_match(const gchar *pWildText, const gchar *pTameText);

CHASSIS_API GString *time_us_to_str(guint64 time_us, GString *str);
