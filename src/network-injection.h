...
NETWORK_API guint _dump_injected_queries(const char *name, network_injection_queue *q);
NETWORK_API GString *injection_queue_pop_head_injected_query(network_injection_queue *q);
